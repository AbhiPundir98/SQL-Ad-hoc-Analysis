# SQL-Ad-hoc-Analysis
This project provides a SQL analysis of AtliQ's (consumer electronics company) business performance.

### Overview

AtliQ Hardwares is a renowned hardware company specializing in PCs, printers, mice, and computers, boasting a global presence. The primary objective of this project is to address ten specific ad hoc requests through SQL queries, unveiling insights and trends within the dataset.
...
1. **SQL Queries:** Contains the Ad hoc requests from AtliQ's leadership. [Ad hoc Requests.pdf](https://github.com/AbhiPundir98/SQL-Ad-hoc-Analysis/blob/main/SQL%20Queries_Adhoc%20Analysis.pdf)
